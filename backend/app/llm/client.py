...
def _gerar_resposta_openrouter(system_prompt: str, mensagem_cliente: str) -> str:
...
PROVEDORES = {
    ...
    # "anthropic": _gerar_resposta_anthropic,  # ainda não implementada
}

def gerar_resposta(system_prompt: str, mensagem_cliente: str) -> str:
    ...
    return funcao_provedor(system_prompt, mensagem_cliente)

def classificar_estruturado(prompt_classificacao: str) -> dict:
    resposta_texto = gerar_resposta("",prompt_classificacao)
